...
test('browser, server and agent complete the correlated protocol round trip', () => {
    ...
    vm.runInNewContext(fs.readFileSync(path.join(__dirname, '../modules_meshcore/omniossendlogs.js'), 'utf8'), agentContext);
    agentModule = agentContext.module.exports;
    const serverContext = {module: {exports: {}}, require, console: {log() {}}, ...fakeTimers};
    vm.runInNewContext(fs.readFileSync(path.join(__dirname, '../omniossendlogs.js'), 'utf8'), serverContext);
